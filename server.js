...
var server = http.createServer(function (request, response) {
  if (request.url === '/') {
    response.end(
      ...
      '<a href="http://localhost:8080/cuteness">Cuteness</a> ' + '<a href="http://localhost:8080/random-joke">Random Joke</a>' )
    ...
    if (random1 < 5) {
      ...
      '<a href="http://localhost:8080/cuteness">Cuteness</a> ' + '<a href="http://localhost:8080">Home</a>')
    } else if (random1 > 15) {
    ...
    response.end(
      ...
      '<a href="http://localhost:8080">Home</a> ' + '<a href="http://localhost:8080/random-joke">Random Joke</a>')
  } else {
